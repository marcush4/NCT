...
desc = 'Decoding using subset selection/start truncation, marginal variant'
...
dimreduc_files = glob.glob('/mnt/Secondary/data/sabes_M1subtruncmarginal/sabes_M1subtruncmarginal_*.dat')

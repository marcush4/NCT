...
with open('/home/akumar/nse/neural_control/subset_indicesS1.pkl', 'rb') as f:
    subset_indices = pickle.load(f)

loader_args = [{'bin_width':50, 'filter_fn':'none', 'filter_kwargs':{}, 'boxcox':0.5, 'spike_threshold':100, 'region':'M1',
                'truncate_start':True, 'subset':subset_indices, 'region':'S1'},
                {'bin_width':50, 'filter_fn':'none', 'filter_kwargs':{}, 'boxcox':0.5, 'spike_threshold':100, 'region':'M1',
                'truncate_start':False, 'subset':subset_indices, 'region':'S1'},
                {'bin_width':50, 'filter_fn':'none', 'filter_kwargs':{}, 'boxcox':0.5, 'spike_threshold':100, 'region':'M1',
                'truncate_start':True, 'subset':None, 'region':'S1'},
                {'bin_width':50, 'filter_fn':'none', 'filter_kwargs':{}, 'boxcox':0.5, 'spike_threshold':100, 'region':'M1',
                'truncate_start':False, 'subset':None, 'region':'S1'}]

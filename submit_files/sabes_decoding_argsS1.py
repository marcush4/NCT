...
#dimreduc_files = glob.glob('/mnt/Secondary/data/sabes_S1subtrunc/sabes_S1subtrunc_*.dat')
dimreduc_files = glob.glob('/home/ankit_kumar/Data/FCCA_revisions/sabes_S1subsetqvar/sabes_S1subsetqvar_*.dat')
...
# Consider different decoder lags

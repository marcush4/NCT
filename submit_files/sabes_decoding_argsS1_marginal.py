...
desc = 'Decoding using subset selection/start truncation for S1, marginal variant'
...
dimreduc_files = glob.glob('/home/ankit_kumar/Data/FCCA_revisions//sabes_S1subtruncmarginal/sabes_S1subtruncmarginal_*.dat')

...
task_args = [{'dim_vals':dimvals, 'n_folds':2, 'dimreduc_method':'PCA', 'dimreduc_args': {}}]
for T in np.array([3]):
    task_args.append({'dim_vals':dimvals, 'n_folds':2, 'dimreduc_method':'LQGCA', 'dimreduc_args': {'T':T, 'loss_type':'trace', 'n_init':2}})
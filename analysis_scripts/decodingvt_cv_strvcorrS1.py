...
def gen_run(name, didxs=np.arange(8)):
    with open(name, 'w') as rsh:
        rsh.write('#!/bin/bash\n')
        for di in didxs:
            rsh.write('mpirun -n 8 python decodingvt_cv_strvcorrS1.py %d\n' % di)
...
if __name__ == '__main__':
    ...
    dpath = '/home/akumar/nse/neural_control/data/decodingvt_cv_strcorr_S1'

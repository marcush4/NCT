...
sys.path.append('/home/ankit_kumar/neural_control')
...
data_files.extend(['%s/%s' % (data_path, f) for f in ['loco_20170210_03.mat',
...
# Go back and trim the data_path for consistency with the rest
...
with open('/mnt/Secondary/data/postprocessed/sabes_su_calcs.dat', 'wb') as f:

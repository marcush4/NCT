...
if __name__ == "__main__":
    ...
    comparisons_save_path = f"{PATH_DICT['tmp']}/activity_regression_scores_tsao.pkl"
    ...
    regions = ['ML', 'AM'] # unique will put this in alph. order. Want ML first for later plots.
    ...
    figpath = PATH_DICT['figs'] + '/activity_regression_total_%s.pdf' % 'tsao'
    ...
    for i in range(4):
        ...
        figpath = f"{PATH_DICT['figs']}/activity_regression_tsao_subplot_{i}.pdf"
        fig.savefig(figpath, bbox_inches='tight', pad_inches=0)
